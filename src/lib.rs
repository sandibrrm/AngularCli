...
#[derive(Debug)]
pub struct AngularCliProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AngularCliProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AngularCli processing");
    
    let mut processor = AngularCliProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AngularCliProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AngularCliProcessor::new(false);
